...
public class JNIDemo extends JFrame {
    ...
    private static JLabel meanLabel, stdDevLabel, milliLabel;
    ...
    static {
        try {
            System.load("/home/neil/devel/IdeaProjects/Lab9/src/Week9/libWeek9_JNIDemo.so");
    ...
    public JNIDemo() {
        ...
        //Font Configuration
        try {
            openSans = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/res/fonts/OpenSans-Regular.ttf")).deriveFont(Font.PLAIN, 22);
        } catch (FontFormatException | IOException e) {
            System.err.println("Could not load OpenSans-Regular.ttf...");
            e.printStackTrace();
        }
        ...
        button.addActionListener(actionEvent -> {
            ...
            if(status == ExitStatuses.SUCCESS) {
                ...
                milliLabel.setText("Time to calculate with multithreading (in milliseconds): " + elapsedTime);

                meanLabel.setVisible(true);
                stdDevLabel.setVisible(true);
                milliLabel.setVisible(true);
        ...
        promptLabel.setFont(openSans);
        errLabel.setFont(openSans);
        errLabel.setForeground(Color.RED);
        errLabel.setVisible(false);

        meanLabel.setFont(openSans);
        meanLabel.setVisible(false);
        meanLabel.setForeground(Color.BLUE);
        stdDevLabel.setFont(openSans);
        stdDevLabel.setForeground(Color.BLUE);
        stdDevLabel.setVisible(false);
        milliLabel.setFont(openSans);
        milliLabel.setForeground(Color.ORANGE);
        milliLabel.setVisible(false);

        textField.setPreferredSize(new Dimension(600, 40));
        textField.setFont(openSans);
        button.setFont(openSans);
